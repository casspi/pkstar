...
export type Rule =
  | {
      ...
      message?: string | ((value: any, filed: Field, data: MetaData) => string)
      required?: boolean
    }
  | Validator
...
export type MetaDataObject<T extends Record<string, any> = Record<string, any>> = Record<
  string,
  Field & T
>

export type MetaDataArray<T extends Record<string, any> = Record<string, any>> = (Field & T)[]
